package scalafiddle.server.modules
...
class SilhouetteModule extends AbstractModule with ScalaModule with AkkaGuiceSupport {
  ...
  def configure() {
    ...
    bindActor[Persistence]("persistence")
  }
  ...
  def provideGitLabProvider(
    ...
    new GitLabProvider(httpLayer, stateProvider, configuration.underlying.as[OAuth2Settings]("silhouette.gitlab"))
  }
